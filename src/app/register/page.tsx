        ...
        <div className="rounded-3xl p-8 border border-border bg-card/90 shadow-2xl backdrop-blur-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black tracking-tight text-foreground">
              Create Your <span className="gradient-text">Portfolio</span>
            </h1>
            <p className="text-xs text-muted-foreground mt-1.5">
              Set up your multi-tenant personal portfolio in seconds
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-border bg-card text-sm text-foreground focus:outline-none focus:border-indigo-500/60 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                >
                  {PROFESSIONS.map((p) => (
              ...
              <p className="text-[11px] text-muted-foreground mt-1">
                Your profession configures your initial presentation template.
              </p>
            </div>
