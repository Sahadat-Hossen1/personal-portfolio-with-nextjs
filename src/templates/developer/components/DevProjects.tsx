    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <p className="reveal reveal-delay-2 text-muted-foreground max-w-xl mb-16">
          A selection of recent full-stack applications, developer tools, and
          ...
          <>
            ...
            <article
              ...
              className={`reveal reveal-delay-${
                i + 1
              } group glass rounded-3xl overflow-hidden border border-border hover:border-primary/30 transition-all duration-500 grid md:grid-cols-12 gap-0 shadow-2xl hover:shadow-indigo-500/10`}
            >
              {/* Image Column */}
              <div
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {others.map((project, i) => (
            <article
              ...
              className={`reveal reveal-delay-${
                i + 2
              } group glass rounded-2xl overflow-hidden border border-border hover:border-primary/30 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl flex flex-col`}
            >
        ...
        {githubEnabled !== false && !!githubUrl && (
          <div className="reveal text-center mt-12">
            <a
              ...
              onClick={() =>
                trackProjectClick("View All Projects", "github", githubUrl)
              }
